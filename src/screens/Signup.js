...
export default function Signup() {
  ...
  return (
    <div style={{ backgroundImage: 'url("https://images.pexels.com/photos/1565982/pexels-photo-1565982.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")', backgroundSize: 'cover',height: '100vh' , paddingTop:'50px'}}>
      <div>
      <Navbar />
      </div>
        ...
        <div className='container' >
          <form className='w-50 m-auto mt-5 border bg-dark  rounded' onSubmit={handleSubmit}>
            ...
            <div className="m-3">
              <button type="button" onClick={handleClick} name="geolocation" className=" btn" style={{backgroundColor:"#C172E9"}}>Click for current Location </button>
            </div>
            <div className="m-3">
